...
module.exports = {
  input: {
    path: "./arches_he_data_transformation/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_he_data_transformation/locale", // output path of all created files
