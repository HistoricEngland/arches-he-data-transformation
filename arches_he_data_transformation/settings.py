"""
Django settings for arches_he_data_transformation project.
"""
...
APP_NAME = "arches_he_data_transformation"
...
DATATYPE_LOCATIONS.append("arches_he_data_transformation.datatypes")
FUNCTION_LOCATIONS.append("arches_he_data_transformation.functions")
ETL_MODULE_LOCATIONS.append("arches_he_data_transformation.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_he_data_transformation.search_components")
...
SECRET_KEY = "django-insecure-)m6diq+aqzey#m32zqa&jbh8jy+zd+k-uk1xlcgtf3b7k811-2"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_he_data_transformation.urls"
ROOT_HOSTCONF = "arches_he_data_transformation.hosts"

DEFAULT_HOST = "arches_he_data_transformation"
...
ELASTICSEARCH_PREFIX = "arches_he_data_transformation"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_he_data_transformation.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_he_data_transformation",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_he_data_transformation.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_he_data_transformation"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_he_data_transformation.search.es_mapping_modifier.EsMappingModifier"]
